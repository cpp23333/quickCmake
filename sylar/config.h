...
namespace sylar
{
    ...
    public:
        ...
        std::string toString() override
        {
            ...
            {
                SYLAR_LOG_ERROR(SYLAR_LOG_ROOT()) << "ConfigVar::toString exception,name:"
                                                  << m_name << e.what() << " convert: "
        ...
        virtual bool fromString(const std::string &val) override
        {
            ...
            {
                SYLAR_LOG_ERROR(SYLAR_LOG_ROOT()) << "ConfigVar::toString exception,name:"
                                                  << m_name << e.what() << " convert: string to "
                                                  << typeid(m_val).name();
            }
            return false;
        }
    ...
    public:
...

        {
            ...
            if (it != s_datas.end())
            {
                ...
                {
                    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "Lookup name" << name << " exists but type not " << typeid(T).name() << " real type = " << it->second->getTypeName() << " " << it->second->toString();
                    return nullptr;
                }
            }
            ...
            {
                SYLAR_LOG_ERROR(SYLAR_LOG_ROOT()) << "Lookup name invalid";
                return nullptr;
            }
